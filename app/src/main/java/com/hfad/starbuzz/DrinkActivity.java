...
public class DrinkActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast toast = Toast.makeText(this, "Database unavailable in DrinkActivity",
                    Toast.LENGTH_SHORT);
            toast.show();
        }
    }
...
//        int drinkNo = (Integer) getIntent().getExtras().get("drinkNo");
        ...
        Object obj = bundle.get("drinkNo");
        if (obj != null) {
            drinkNo = (Integer) obj;
        }
        new UpdateDrinkTask().execute(drinkNo);
////        if (bundle == null || !bundle.containsKey("drinkNo") || bundle.get("drinkNo") == null) {
////            return;
////        } else {
////            drinkNo = (Integer) bundle.get("drinkNo");
////        }
//
//        CheckBox favorite = (CheckBox) findViewById(R.id.favorite);
